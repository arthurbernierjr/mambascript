...
CS = require './nodes'
JS = require './js-nodes'
MainCoffee = require 'coffeescript'
...
jsReserved = [
  ...
  'typeof', 'var', 'void', 'while', 'with', 'yield', 'arguments', 'eval', 'present'
]
  ...
  defaultRules = [
    ...
    [CS.Program, ({body, inScope, options}) ->
      ...
      program.leadingComments = [
        type: 'Line'
        value: " Generated by KofuScript #{pkg.version} \nvar present = console.log; \n// Generated by KofuScript #{pkg.version} "
      ]
      program
    ]
    [CS.Block, ({statements}) ->

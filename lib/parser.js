module.exports = (function(){
  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse__TypeStruct() {
        var cacheKey = "_TypeStruct@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(key, val) { return [key, val]; })(r5, r9);
        }
        if (r0 === null) {
          pos = r1;
        }
      ...
      function parse_TypeStruct() {
        var cacheKey = "TypeStruct@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;

module.exports = (function(){
  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_TemplateKeys() {
        var cacheKey = "TemplateKeys@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_TypeNameSymbol() {
        var cacheKey = "TypeNameSymbol@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_TypeAnnotation() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(type) {return rp({dataType:type});})(r5);
        }
        if (r0 === null) {
          pos = r1;
        }
      ...
      function parse_Assignable() {
        ...
        if (r0 === null) {
          ...
          if (r0 !== null) {
            reportedPos = r1;
            r0 = (function(i, annotation) { i.annotation = annotation; return rp(i); })(r4, r6);
          }
          if (r0 === null) {
            pos = r1;
          }

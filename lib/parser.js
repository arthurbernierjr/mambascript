  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_callExpression() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(accesses, secondaryArgs) {
              if(accesses)
      ...
      function parse_memberExpression() {
        ...
        r4 = pos;
        r5 = pos;
        r6 = parse_primaryExpression();
        if (r6 !== null) {
          r7 = parse_symbolTypeArguments();
          r7 = r7 !== null ? r7 : "";
          if (r7 !== null) {
            r3 = [r6, r7];
          } else {
        ...
        if (r3 === null) {
          ...
          if (r6 !== null) {
            ...
            if (r7 !== null) {
              ...
              if (r8 !== null) {
                r9 = parse_symbolTypeArguments();
                r9 = r9 !== null ? r9 : "";
                if (r9 !== null) {
                  r10 = parse_argumentList();
                  if (r10 !== null) {
                    r3 = [r6, r7, r8, r9, r10];
                  } else {
                    r3 = null;
      ...
      function parse_memberAccess() {
        ...
        if (r3 !== null) {
          reportedPos = r4;
          r3 = (function(e, typeArgs) {return e;})(r6, r7);
        }
        if (r3 === null) {
          pos = r4;
        }
      ...
      function parse_implementArguments() {
        var cacheKey = "implementArguments@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_symbolTypeArguments() {
        var cacheKey = "symbolTypeArguments@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_class() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(name, typeArgs, parent, implementArguments, body) {
              var ctor = null;
      ...
      function parse_blueprint() {
        var cacheKey = "blueprint@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_forEveryOf() {
        var cacheKey = "forEveryOf@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_forEveryIn() {
        var cacheKey = "forEveryIn@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_functionLiteral() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(params, returnType, arrow, body) {
              var constructor;
              switch(arrow) {
          ...
          if (r0 === null) {
            ...
            if (r0 === null) {
              ...
              if (r0 === null) {
                ...
                if (r0 === null) {
                  r1 = pos;
                  if (input.substr(pos, 17) === "__MAMBA_VERSION__") {
                    r0 = "__MAMBA_VERSION__";
                    pos += 17;
                  } else {
                    r0 = null;
                    if (reportFailures === 0) {
                      matchFailed("\"__MAMBA_VERSION__\"");
                    }
                  }
                  if (r0 !== null) {
                    reportedPos = r1;
      ...
      function parse_Assignable() {
        ...
        if (r0 === null) {
          ...
          if (r0 !== null) {
            reportedPos = r1;
            r0 = (function(i, typeAnnotation) { i.typeAnnotation = typeAnnotation || null; return rp(i); })(r4, r6);
          }
          if (r0 === null) {
            pos = r1;
          }
      ...
      function parse_BLUEPRINT() {
        ...
        r1 = pos;
        r2 = pos;
        if (input.substr(pos, 9) === "blueprint") {
          r3 = "blueprint";
          pos += 9;
        } else {
          r3 = null;
          if (reportFailures === 0) {
            matchFailed("\"blueprint\"");
          }
        }
        if (r3 !== null) {
          r5 = pos;
      ...
      function parse_THANOS() {
        var cacheKey = "THANOS@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_INHERITSFROM() {
        var cacheKey = "INHERITSFROM@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        r1 = pos;
        r2 = pos;
        if (input.substr(pos, 12) === "inheritsFrom") {
          r3 = "inheritsFrom";
          pos += 12;
        } else {
          r3 = null;
          if (reportFailures === 0) {
            matchFailed("\"inheritsFrom\"");
          }
        }
        if (r3 !== null) {
          r5 = pos;
      ...
      function parse_FOREVERY() {
        ...
        r1 = pos;
        r2 = pos;
        if (input.substr(pos, 8) === "forEvery") {
          r3 = "forEvery";
          pos += 8;
        } else {
          r3 = null;
          if (reportFailures === 0) {
            matchFailed("\"forEvery\"");
          }
        }
        if (r3 !== null) {
          r5 = pos;
      ...
      function parse_AREYOUA() {
        var cacheKey = "AREYOUA@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_structdef() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(name, implementArguments, props) {
      ...
      function parse_vardef() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(isStatic, name, expr) {
          var s = rp(new CS.Int(0))
          s.nodeType = 'vardef';
          s.name = name;
          s.expr = expr;
      ...
      function parse_typeExpr() {
        var cacheKey = "typeExpr@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        r0 = parse_primaryTypeFunction();
        if (r0 === null) {
          r0 = parse_typeFunction();
          if (r0 === null) {
            r0 = parse_typeBlock();
            if (r0 === null) {
              r0 = parse_typeIdentifier();
            }
          }
        }
      ...
      function parse_typeBlock() {
        var cacheKey = "typeBlock@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_typeBlockBody() {
        var cacheKey = "typeBlockBody@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_typeBlockMemberList() {
        var cacheKey = "typeBlockMemberList@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_typeBlockMember() {
        var cacheKey = "typeBlockMember@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_returnTypeExpr() {
        var cacheKey = "returnTypeExpr@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_typeRef() {
        var cacheKey = "typeRef@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_typeIdentifier() {
        var cacheKey = "typeIdentifier@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse__typeIdentifier() {
        var cacheKey = "_typeIdentifier@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(symbol, args, nullable, isArray, wholeNullable, splats) {
      ...
      function parse_isArray() {
        var cacheKey = "isArray@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_VoidAlias() {
        var cacheKey = "VoidAlias@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function() {return {isArray: false, typeRef: 'Void', typeArguments: []} })();
        }
        if (r0 === null) {
          pos = r1;
        }
      ...
      function parse_typeArgumentLiteral() {
        var cacheKey = "typeArgumentLiteral@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_typeArguments() {
        var cacheKey = "typeArguments@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_typeFunction() {
        var cacheKey = "typeFunction@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        r1 = pos;
        r2 = pos;
        r3 = parse_typeFunctionArguments();
        if (r3 !== null) {
          r4 = parse__();
          if (r4 !== null) {
            if (input.substr(pos, 2) === "->") {
      ...
      function parse_primaryTypeFunction() {
        var cacheKey = "primaryTypeFunction@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_typeFunctionArguments() {
        var cacheKey = "typeFunctionArguments@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_returnTypeLiteral() {
        var cacheKey = "returnTypeLiteral@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(type) {return type;})(r6);
        }
        if (r0 === null) {
          pos = r1;
        }
      ...
      function parse_typeAnnotation() {
        var cacheKey = "typeAnnotation@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(type) {return rp(type);})(r5);
        }
        if (r0 === null) {
          pos = r1;
        }
      ...
      function parse_typeSplitter() {
        var cacheKey = "typeSplitter@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;

module.exports = (function(){
  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_memberExpressionWithArgs() {
        var cacheKey = "memberExpressionWithArgs@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_callExpression() {
        ...
        if (r0 === null) {
          r1 = pos;
          r2 = pos;
          r3 = parse_memberExpressionWithArgs();
          if (r3 !== null) {
            r4 = parse_callExpressionAccesses();
            r4 = r4 !== null ? r4 : "";
            if (r4 !== null) {
      ...
      function parse_memberExpression() {
        ...
        if (r3 !== null) {
          reportedPos = r4;
          r3 = (function(e, typeArgs) {e.typeArguments = typeArgs; return e;})(r6, r7);
        }
        if (r3 === null) {
          pos = r4;
        }
      ...
      function parse_classImplements() {
        var cacheKey = "classImplements@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_classTypeArguments() {
        var cacheKey = "classTypeArguments@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_class() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(name, typeArgs, parent, impl, body) {
              var ctor = null;
      ...
      function parse_typeLiteralBody() {
        var cacheKey = "typeLiteralBody@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        r3 = parse_TERMINDENT();
        if (r3 !== null) {
          r4 = parse_typeLiteralMemberList();
          if (r4 !== null) {
            r5 = parse_DEDENT();
            if (r5 !== null) {
              r0 = [r3, r4, r5];
      ...
      function parse_typeLiteralMemberList() {
        var cacheKey = "typeLiteralMemberList@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_typeLiteralMember() {
        var cacheKey = "typeLiteralMember@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_typeIdentifier() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(v) {return {identifier:v, nodeType: 'identifier'}})(r0);
        }
        if (r0 === null) {
          pos = r1;
        }
        if (r0 === null) {
          ...
          if (r0 !== null) {
            reportedPos = r1;
            r0 = (function(ret) { return {identifier: ret, nodeType: 'identifier'};})(r5);
          }
          if (r0 === null) {
            pos = r1;
          }
          if (r0 === null) {
            ...
            if (r0 !== null) {
              reportedPos = r1;
              r0 = (function(t) { return {identifier: t, nodeType: 'identifier'};})(r0);
            }
            if (r0 === null) {
              pos = r1;
            }
      ...
      function parse__typeIdentifier() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(symbol, args, nullable, isArray, wholeNullable) {

  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_callExpression() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(accesses, typeArgs, secondaryArgs) {
              if(accesses)
        ...
        if (r0 === null) {
          ...
          if (r3 !== null) {
            ...
            if (r4 !== null) {
              ...
              if (r5 !== null) {
                ...
                r8 = r8 !== null ? r8 : "";
                if (r8 !== null) {
                  r9 = parse_secondaryArgumentList();
                  if (r9 !== null) {
                    r6 = [r8, r9];
                  } else {
                    r6 = null;
          ...
          if (r0 !== null) {
            reportedPos = r1;
            r0 = (function(fn, accesses, typeArgs, secondaryArgs) {
      ...
      function parse_typeSymbol() {
        var cacheKey = "typeSymbol@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (r0 === null) {
          ...
          if (r0 === null) {
            ...
            if (r0 !== null) {
              reportedPos = r1;
              r0 = (function(t) { return {identifier: t, nodeType: 'identifier'};})(r4);
            }
            if (r0 === null) {
              pos = r1;
            }
      ...
      function parse__typeSymbol() {
        var cacheKey = "_typeSymbol@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse__typeFunction() {
        var cacheKey = "_typeFunction@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;

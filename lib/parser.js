  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_classImplements() {
        ...
        if (r3 !== null) {
          ...
          if (r4 !== null) {
            r5 = parse___();
            if (r5 !== null) {
              r6 = parse_ObjectInitialiserKeys();
              if (r6 !== null) {
                r7 = parse__();
                if (r7 !== null) {
                  r8 = [];
                  ...
                  if (r11 !== null) {
                    ...
                    if (r12 !== null) {
                      r13 = parse__();
                      if (r13 !== null) {
                        r14 = parse_ObjectInitialiserKeys();
                        if (r14 !== null) {
                          r9 = [r11, r12, r13, r14];
                        } else {
                          r9 = null;
      ...
      function parse_typeLiteralMember() {
        ...
        if (r0 !== null) {
          ...
          r0 = (function(symbol, expr) {
                // TODO: fix identifier as typeExpr
                if(expr.typeName)
                  return {identifier:symbol, typeAnnotation: {identifier: expr}};
                else
                  return {identifier:symbol, typeAnnotation: expr};
              })(r3, r7);
        }
        if (r0 === null) {
          pos = r1;
      ...
      function parse__typeSymbol() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(symbol, args, isArray) {
      ...
      function parse_VoidAlias() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function() {return {isArray: false, typeName: 'Void', typeArguments: []} })();
        }
        if (r0 === null) {
          pos = r1;
        }
      ...
      function parse_typeExpr() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(e) { return {properties:e}; })(r0);
        }
        if (r0 === null) {
          pos = r1;
        }
      ...
      function parse_Assignable() {
        ...
        if (r0 === null) {
          ...
          if (r0 !== null) {
            reportedPos = r1;
            r0 = (function(i, typeAnnotation) { i.typeAnnotation = typeAnnotation; return rp(i); })(r4, r6);
          }
          if (r0 === null) {
            pos = r1;
          }

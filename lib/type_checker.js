void function () {
    var _, cache$, checkNodes, checkType, ClassScope, CS, debug, FunctionScope, identifier, ImplicitAnyAnnotation, initializeGlobalTypes, isAcceptable, isAcceptableFunctionType, isAcceptablePrimitiveSymbol, isAcceptableStruct, pj, render, reporter, same, Scope, typeErrorText, walk, walk_objectInitializer, walkArrayInializer, walkAssignOp, walkBinOp, walkBlock, walkBool, walkClass, walkClassProtoAssignOp, walkConditional, walkFloat, walkFor, walkFunction, walkFunctionApplication, walkIdentifier, walkInt, walkMemberAccess, walkNewOp, walkNumbers, walkPrimitives, walkProgram, walkRange, walkReturn, walkString, walkStruct, walkSwitch, walkThis, walkVardef;
    pj = function () {
        try {
    ...
    checkType = function (scope, left, right) {
        var err, ret;
    ...
    walkBinOp = function (node, scope) {
        var cache$1, leftAnnotation, leftRef, rightAnnotation, rightRef;

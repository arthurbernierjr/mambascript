...
walk_class = function (node, scope) {
  var classScope, cls, constructorScope, fname, index, key, name, obj, param, parent, predef, statement, val;
  ...
  if (null != node.ctor) {
    ...
    if (null != (null != node.ctor.expression.body ? node.ctor.expression.body.statements : void 0))
      for (var i$3 = 0, length$3 = node.ctor.expression.body.statements.length; i$3 < length$3; ++i$3) {
        statement = node.ctor.expression.body.statements[i$3];
  ...
  if (null != node.nameAssignee ? node.nameAssignee.data : void 0) {
    ...
    if (null != (null != node.impl ? node.impl.length : void 0))
      for (var i$5 = 0, length$5 = node.impl.length; i$5 < length$5; ++i$5) {
        name = node.impl[i$5];

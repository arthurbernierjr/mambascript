void function () {
    var _, cache$, checkNodes, ClassScope, CS, debug, FunctionScope, g, identifier, ImplicitAnyAnnotation, initializeGlobalTypes, isAcceptable, isAcceptablePrimitiveSymbol, isAcceptableStruct, pj, render, reporter, same, Scope, typeErrorText, walk, walk_arrayInializer, walk_assignOp, walk_binOp, walk_block, walk_bool, walk_class, walk_classProtoAssignOp, walk_conditional, walk_float, walk_for, walk_function, walk_functionApplication, walk_identifier, walk_int, walk_memberAccess, walk_newOp, walk_numbers, walk_objectInitializer, walk_primitives, walk_program, walk_range, walk_return, walk_string, walk_struct, walk_switch, walk_this, walk_vardef;
    pj = function () {
        try {
    ...
    walk = function (node, scope) {
        var s;
        if (null != (null != node ? node.raw : void 0))

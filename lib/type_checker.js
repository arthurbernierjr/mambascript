...
walk_struct = function (node, scope) {
  if (null != (null != node.name ? node.name._base_ : void 0)) {
    return scope.addType(node.name._base_, node.expr, node.name._templates_);
  } else if (null != (null != node.name ? node.name.left : void 0)) {
...
walk_assignOp = function (node, scope) {
  ...
  if (pre_registered_annotation && ((null != right.annotation && null != right.annotation.dataType ? right.annotation.dataType.dataType : void 0) === (null != left.annotation && null != left.annotation.dataType ? left.annotation.dataType.dataType : void 0) && (null != left.annotation && null != left.annotation.dataType ? left.annotation.dataType.dataType : void 0) === 'Function')) {
    ...
    for (var i$ = 0, length$ = left.annotation.dataType['arguments'].length; i$ < length$; ++i$) {
      arg = left.annotation.dataType['arguments'][i$];
      n = i$;
      if (scope.checkAcceptableObject(null != left.annotation.dataType['arguments'][n] ? left.annotation.dataType['arguments'][n].dataType : void 0, null != right.annotation.dataType['arguments'][n] ? right.annotation.dataType['arguments'][n].dataType : void 0)) {
    ...
    if (predef) {
      ...
      for (var i$ = 0, length$ = node.parameters.length; i$ < length$; ++i$) {
        ...
        if (param.members) {
          ...
          if (err = scope.checkAcceptableObject(null != predef['arguments'] ? predef['arguments'][index] : void 0, null != t ? t.dataType : void 0)) {
            err = typeErrorText(null != predef['arguments'] ? predef['arguments'][index] : void 0, null != t ? t.dataType : void 0);
            reporter.add_error(node, err);
          }
          if (!(null != (null != t ? t.dataType : void 0)))

// Generated by CoffeeScript 0.8.2
...
walk_assignOp = function (node, scope) {
  ...
  if (left['instanceof'](CS.ArrayInitialiser)) {
    return function (accum$) {
      var err, index, l, member, r;
      for (var i$ = 0, length$ = left.members.length; i$ < length$; ++i$) {
        member = left.members[i$];
        index = i$;
        if (!(null != member.data))
          continue;
        l = null != left.annotation && null != left.annotation.type && null != left.annotation.type.array ? left.annotation.type.array[index] : void 0;
        r = null != right.annotation && null != right.annotation.type && null != right.annotation.type.array ? right.annotation.type.array[index] : void 0;
        accum$.push((err = scope.checkAcceptableObject(l, r)) ? reporter.add_error(node, err) : scope.addVar(member.data, l || 'Any'));
      }
      return accum$;
    }.call(this, []);
  } else if (null != (null != left ? left.members : void 0)) {
    return function (accum$) {
      var err, l_type, member;
      for (var i$ = 0, length$ = left.members.length; i$ < length$; ++i$) {
        member = left.members[i$];
        if (!(null != (null != member.key ? member.key.data : void 0)))
          continue;
        accum$.push(scope.getVarInScope(member.key.data) ? (l_type = scope.getVarInScope(member.key.data).type, (err = scope.checkAcceptableObject(l_type, null != right.annotation && null != right.annotation.type ? right.annotation.type[member.key.data] : void 0)) ? reporter.add_error(node, err) : void 0) : scope.addVar(member.key.data, 'Any'));
      }
      return accum$;
    }.call(this, []);
      ...
      if (constructorScope.getThis('_constructor_')) {
        ...
        for (var i$3 = 0, length$3 = node.ctor.expression.parameters.length; i$3 < length$3; ++i$3) {
          ...
          if (!(null != param))
            continue;
          walk(param, constructorScope);
          constructorScope.addVar(param.data, null != (null != param && null != param.annotation ? param.annotation.type : void 0) ? null != param && null != param.annotation ? param.annotation.type : void 0 : 'Any');
        }
      }
...
walk_function = function (node, scope, predef) {
  var _args_, err, functionScope, index, last_expr, param, t;
  if (null == predef)
    predef = null;
  ...
  if (null != node.parameters)
    if (predef) {
      ...
      for (var i$ = 0, length$ = node.parameters.length; i$ < length$; ++i$) {
        ...
        index = i$;
        if ((null != param.expression ? param.expression.raw : void 0) === '@' || (null != param.expression ? param.expression.raw : void 0) === 'this') {
          t = functionScope.getThis(param.memberName);
          if (err = scope.checkAcceptableObject(null != predef._args_ ? predef._args_[index] : void 0, null != t ? t.type : void 0))
            reporter.add_error(node, err);
          if (!(null != (null != t ? t.type : void 0)))

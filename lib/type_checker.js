...
(function() {
  ...
  _ref = require('./types'), initializeGlobalTypes = _ref.initializeGlobalTypes, Scope = _ref.Scope;
  ...
  walk_assignOp = function(node, scope) {
    var err, left, pre_registered_annotation, right, symbol, _ref1, _ref2;
    pre_registered_annotation = node.assignee.annotation;
    left = node.assignee;
    right = node.expression;
    walk(left, scope);
    if ((typeof right["instanceof"] === "function" ? right["instanceof"](CS.Function) : void 0) && pre_registered_annotation) {
  ...
  walk_function = function(node, scope, predef) {
    var cur, err, functionScope, index, last_expr, param, _args_, _i, _j, _len, _len1, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    if (predef == null) {
      predef = null;
    }
    ...
    if (node.parameters != null) {
      if (predef) {
        ...
        _ref3 = node.parameters;
        for (index = _j = 0, _len1 = _ref3.length; _j < _len1; index = ++_j) {
          param = _ref3[index];
          functionScope.addVar(param.data, (_ref4 = (_ref5 = param.annotation) != null ? _ref5.type : void 0) != null ? _ref4 : 'Any');
        }
      }
    }
    walk(node.body, functionScope);
    if (((_ref6 = node.annotation) != null ? (_ref7 = _ref6.type) != null ? _ref7._return_ : void 0 : void 0) !== 'Any') {
      last_expr = ((_ref8 = node.body) != null ? (_ref9 = _ref8.statements) != null ? _ref9.length : void 0 : void 0) ? (_ref10 = node.body.statements) != null ? _ref10[((_ref11 = node.body) != null ? (_ref12 = _ref11.statements) != null ? _ref12.length : void 0 : void 0) - 1] : void 0 : node.body;
      if (err = scope.checkAcceptableObject(node.annotation.type._return_, (_ref13 = last_expr.annotation) != null ? _ref13.type : void 0)) {
        return reporter.add_error(node, err);
      }
    } else {
      last_expr = ((_ref14 = node.body) != null ? (_ref15 = _ref14.statements) != null ? _ref15.length : void 0 : void 0) ? (_ref16 = node.body.statements) != null ? _ref16[((_ref17 = node.body) != null ? (_ref18 = _ref17.statements) != null ? _ref18.length : void 0 : void 0) - 1] : void 0 : node.body;
      if (node.annotation != null) {
        return node.annotation.type._return_ = last_expr != null ? (_ref19 = last_expr.annotation) != null ? _ref19.type : void 0 : void 0;
      }
    }
  };

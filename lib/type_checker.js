void function () {
    ...
    walk_newOp = function (node, scope) {
        ...
        if (Type) {
            ...
            if (err = scope.checkAcceptableObject(Type.dataType._constructor_, {
                ...
                err = typeErrorText(Type.dataType._constructor_, {
                    _args_: null != _args_ ? _args_ : [],
                    returnType: 'Any'
                });
    ...
    walk_assignOp = function (node, scope) {
        var arg, err, index, l, l_type, left, member, n, pre_registered_annotation, r, right, symbol, T;
        left = node.assignee;
        right = node.expression;
        pre_registered_annotation = left.annotation;
        symbol = left.data;
        walk(left, scope);
        if (pre_registered_annotation && ((null != right.annotation && null != right.annotation.dataType ? right.annotation.dataType.dataType : void 0) === (null != left.annotation && null != left.annotation.dataType ? left.annotation.dataType.dataType : void 0) && (null != left.annotation && null != left.annotation.dataType ? left.annotation.dataType.dataType : void 0) === 'Function')) {
            ...
            for (var i$ = 0, length$ = left.annotation.dataType._args_.length; i$ < length$; ++i$) {
                arg = left.annotation.dataType._args_[i$];
                n = i$;
                if (scope.checkAcceptableObject(null != left.annotation.dataType._args_[n] ? left.annotation.dataType._args_[n].dataType : void 0, null != right.annotation.dataType._args_[n] ? right.annotation.dataType._args_[n].dataType : void 0)) {
        ...
        if (left['instanceof'](CS.ArrayInitialiser)) {
            ...
            return function (accum$1) {
                for (var i$2 = 0, length$2 = left.members.length; i$2 < length$2; ++i$2) {
                    ...
                    if (!(null != (null != member.key ? member.key.data : void 0)))
                        continue;
                    accum$1.push(scope.getVarInScope(member.key.data) ? (l_type = scope.getVarInScope(member.key.data).dataType, (err = scope.checkAcceptableObject(l_type, null != right.annotation && null != right.annotation.dataType ? right.annotation.dataType[member.key.data] : void 0)) ? (err = typeErrorText(l_type, null != right.annotation && null != right.annotation.dataType ? right.annotation.dataType[member.key.data] : void 0), reporter.add_error(node, err)) : void 0) : scope.addVar(member.key.data, 'Any', false));
                }
                return accum$1;
            }.call(this, []);
            ...
            if (!pre_registered_annotation && (null != right.annotation ? right.annotation.explicit : void 0)) {
                return scope.addVar(symbol, right.annotation.dataType, true);
            } else {
                return scope.addVar(symbol, left.annotation.dataType, true);
            }
        } else {
    ...
    walk_this = function (node, scope) {
        ...
        if (null != node.annotation)
            ...
            return node.annotation = { dataType: dataType };
    };
    ...
    walk_objectInitializer = function (node, scope) {
        ...
        if (null != node.annotation)
            ...
            return node.annotation = { dataType: obj };
    };
    ...
    walk_function = function (node, scope, predef) {
                ...
                for (var i$ = 0, length$ = node.parameters.length; i$ < length$; ++i$) {
                    ...
                    if (param.members) {
                        ...
                        if (err = scope.checkAcceptableObject(null != predef._args_ ? predef._args_[index] : void 0, null != t ? t.dataType : void 0)) {
                            err = typeErrorText(null != predef._args_ ? predef._args_[index] : void 0, null != t ? t.dataType : void 0);
                            reporter.add_error(node, err);
                        }
                        if (!(null != (null != t ? t.dataType : void 0)))
        ...
        if ((null != node.annotation && null != node.annotation.dataType ? node.annotation.dataType.returnType : void 0) !== 'Any') {
            ...
            if (err = scope.checkAcceptableObject(null != node.annotation ? node.annotation.dataType.returnType : void 0, null != last_expr && null != last_expr.annotation ? last_expr.annotation.dataType : void 0)) {
                err = typeErrorText(null != node.annotation ? node.annotation.dataType.returnType : void 0, null != last_expr && null != last_expr.annotation ? last_expr.annotation.dataType : void 0);
                return reporter.add_error(node, err);
            }
        } else {
            last_expr = (null != node.body && null != node.body.statements ? node.body.statements.length : void 0) ? null != node.body.statements ? node.body.statements[(null != node.body && null != node.body.statements ? node.body.statements.length : void 0) - 1] : void 0 : node.body;
            if (null != node.annotation)
                return node.annotation.dataType.returnType = null != last_expr && null != last_expr.annotation ? last_expr.annotation.dataType : void 0;
        }
    };
    walk_functionApplication = function (node, scope) {
        ...
        node.annotation = { dataType: null != node['function'].annotation && null != node['function'].annotation.dataType ? node['function'].annotation.dataType.returnType : void 0 };
        if (node['function'].annotation) {
            ...
            if (err = scope.checkAcceptableObject(node['function'].annotation.dataType, {
                ...
                err = typeErrorText(node['function'].annotation.dataType, {
                    _args_: null != _args_ ? _args_ : [],
                    returnType: 'Any'
                });
                return reporter.add_error(node, err);

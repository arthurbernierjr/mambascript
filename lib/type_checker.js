...
walk_conditional = function (node, scope) {
  var alternate_annotation, i, n, possibilities;
...
walk_assignOp = function (node, scope) {
  var el, infered, is_registered, left, registered, right, symbol;
  left = node.assignee;
  ...
  if (left['instanceof'](CS.Identifier)) {
    ...
    if (null != left.annotation.type && null != registered && left.annotation.type !== 'Any') {
      ...
      if (left.annotation.type === 'Any') {
        ...
        return function (accum$) {
          var p;
          for (var i$ = 0, length$ = right.annotation.possibilities.length; i$ < length$; ++i$) {
            p = right.annotation.possibilities[i$];
            accum$.push(scope.checkAcceptableObject(left.annotation.type, p.type));
          }
          return accum$;
        }.call(this, []);
      } else if (right['instanceof'](CS.ForIn)) {
        return scope.checkAcceptableObject(left.annotation.type.array, scope.extendTypeLiteral(right.annotation.type));
        ...
        if (typeof right.annotation.type.array === 'string') {
          ...
          for (var i$ = 0, length$ = right.annotation.type.array.length; i$ < length$; ++i$) {
            el = right.annotation.type.array[i$];
      ...
      } else if (typeof scope.extendTypeLiteral(left.annotation.type) === 'object') {
      ...
      } else if (left.annotation.type === infered) {
        return scope.addVar(symbol, left.annotation.type);
      } else {

...
(function() {
  var CS, Scope, TypeSymbol, VarSymbol, checkAcceptableObject, checkNodes, initializeGlobalTypes, render, walk;
  ...
  checkAcceptableObject = function(left, right) {
    ...
    } else if ((left != null ? left.array : void 0) != null) {
  ...
  walk = function(node, currentScope) {
    var args, assigning, el, expected, expression, infered, key, left, nextScope, obj, objectScope, registered, right, symbol, target_type, type, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    switch (false) {
      case node !== void 0:
        break;
      ...
      case !node["instanceof"](CS.MemberAccessOps):
        ...
        type = currentScope.extendTypeLiteral((_ref = node.expression.annotation) != null ? _ref.type : void 0);
        if (type != null) {
          return node.annotation = {
        ...
        return node.annotation != null ? node.annotation : node.annotation = {
          type: {
            array: node.members.map(function(m) {
              var _ref1;
              return (_ref1 = m.annotation) != null ? _ref1.type : void 0;
            })
          },
          implicit: true
        };
      ...
      case !node["instanceof"](CS.Function):
        args = node.parameters.map(function(param) {
          var _ref4, _ref5;
          return (_ref4 = (_ref5 = param.annotation) != null ? _ref5.type : void 0) != null ? _ref4 : 'Any';
        });
        ...
        node.parameters.map(function(param) {
          var _ref4, _ref5;
          try {
            return typeof objectScope.addVar === "function" ? objectScope.addVar(param.data, (_ref4 = (_ref5 = param.annotation) != null ? _ref5.type : void 0) != null ? _ref4 : 'Any') : void 0;
          } catch (_error) {
            return 'ignore but brake on somewhere. why?';
          }
        });
        return walk((_ref4 = node.body) != null ? _ref4.statements : void 0, objectScope);
      case !node["instanceof"](CS.FunctionApplication):
        ...
        if ((expected != null) && expected !== 'Any') {
          args = (_ref5 = node["arguments"]) != null ? _ref5.map(function(arg) {
            var _ref6;
            return (_ref6 = arg.annotation) != null ? _ref6.type : void 0;
          }) : void 0;
      ...
      case !node["instanceof"](CS.AssignOp):
        ...
        if (left.memberName != null) {
          ...
          infered = (_ref6 = right.annotation) != null ? _ref6.type : void 0;
        ...
        symbol = left.data;
        registered = currentScope.getVarInScope(symbol);
        infered = (_ref7 = right.annotation) != null ? _ref7.type : void 0;
        ...
        if ((assigning != null) && (registered != null)) {
          ...
          } else if (((_ref8 = right.annotation) != null ? _ref8.type.array : void 0) != null) {
            _ref9 = right.annotation.type.array;

...
walk = function (node, currentScope) {
  var alternate_annotation, args, assigning, cache$2, el, expected, expression, functionScope, i, infered, key, last_annotation, last_expr, left, n, nextScope, nop, obj, possibilities, registered, right, symbol, target_type, type;
  ...
  case !node['instanceof'](CS.Function):
    ...
    if ((null != node.annotation && null != node.annotation.type ? node.annotation.type.returns : void 0) !== 'Any') {
      console.log('~~~~~~~~~~', null != node.annotation && null != node.annotation.type ? node.annotation.type.returns : void 0);

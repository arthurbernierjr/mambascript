...
(function() {
  ...
  walk = function(node, currentScope) {
    var args, assigning, el, expected, expression, infered, key, left, nextScope, obj, objectScope, registered, right, symbol, target_type, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
    switch (false) {
      case node !== void 0:
        break;
        ...
        return node.annotation != null ? node.annotation : node.annotation = {
          type: {
            array: node.members.map(function(m) {
              var _ref;
              return (_ref = m.annotation) != null ? _ref.type : void 0;
            })
          },
          implicit: true
        };
      ...
      case !node["instanceof"](CS.AssignOp):
        ...
        if ((assigning != null) && (registered != null)) {
          ...
          } else if (((_ref7 = right.annotation) != null ? _ref7.type.array : void 0) != null) {
            _ref8 = right.annotation.type.array;

...
walk = function (node, currentScope) {
  var alternate_annotation, args, assigning, cache$2, cache$3, el, expected, expression, i, infered, key, last_annotation, left, n, nextScope, obj, objectScope, possibilities, registered, right, symbol, target_type, type;
  console.log('node name', null != node ? node.className : void 0);
  switch (false) {
  case !(node === void 0):
    return;
  ...
  case !node['instanceof'](CS.Identifier):
    if (null != node.annotation)
      ...
      return node.annotation = {
        type: (cache$2 = currentScope.getVar(node.data), null != cache$2 ? cache$2 : 'Any'),
        implicit: true
      };
  ...
  case !node['instanceof'](CS.ObjectInitialiser):
    ...
    for (var i$2 = 0, length$2 = node.members.length; i$2 < length$2; ++i$2) {
      {
        cache$3 = node.members[i$2];
    ...
    if (left['instanceof'](CS.Identifier)) {
      ...
      if (null != assigning && null != registered) {
        ...
        if (assigning === 'Any') {
          ...
          return function (accum$) {
            var p;
            for (var i$3 = 0, length$3 = right.annotation.possibilities.length; i$3 < length$3; ++i$3) {
              p = right.annotation.possibilities[i$3];
          ...
          for (var i$3 = 0, length$3 = right.annotation.type.array.length; i$3 < length$3; ++i$3) {
            el = right.annotation.type.array[i$3];

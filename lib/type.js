...
var checkAcceptableObject, checkNodes, console, CS, initializeGlobalTypes, Scope, TypeSymbol, VarSymbol, walk;
console = {
  log: function () {
  }
};
...
walk = function (node, currentScope) {
  var assigning, cache$, cache$1, expected, expression, infered, key, left, nextScope, obj, objectScope, registered, right, symbol;
  switch (false) {
  case !(node === void 0):
    return;

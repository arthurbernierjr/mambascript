...
walk = function (node, currentScope) {
  var alternate_annotation, args, assigning, cache$2, el, expected, expression, i, infered, key, last_annotation, left, n, nextScope, obj, objectScope, possibilities, registered, right, symbol, target_type, type;
  ...
  case !node['instanceof'](CS.ForOf):
    return console.log('forof', render(node));

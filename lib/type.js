...
var checkNodes, console, CS, initializeGlobalTypes, Scope, TypeSymbol, VarSymbol, walk;
console = {
  log: function () {
  }
};
...
walk = function (node, currentScope) {
  var assigning, cache$, expected, expression, infered, key, left, obj, registered, right, scope, symbol, val;
  switch (false) {
  case !(node === void 0):
    return;

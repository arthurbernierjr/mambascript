...
// Generated by KofuScript 0.0.4-alpha.3 
var CoffeeScript, Compiler, cscodegen, escodegen, escodegenFormat, ext, formatParserError, NewCoffeScript, Nodes, Optimiser, Parser, pkg, Preprocessor, reporter, transformImports, TypeError, TypeWalker;
...
CoffeeScript = {
  ...
  jsEsm: function (jsAst, options) {
    ...
    return transformImports(code, function (importDefs) {
      return importDefs.forEach(function (importDef) {
        return importDef.importedExport.isImportedAsCJS = false;
      });
    });
  },
  ...
  smoothCompile: function (input, options) {
    ...
    return CoffeeScript.jsEsm(jsAST, { compact: options.compact || options.minify });
  },

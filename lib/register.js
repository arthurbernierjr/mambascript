...
// Generated by KofuScript 0.0.4-alpha.5 
var argv, child_process, coffeeBinary, compile, compileWithOriginalCoffee, fork, fs, KofuScript, path, runModule;
...
compile = function (module, filename, opts) {
  ...
  csAst = KofuScript.parse(input, opts);
  jsAst = KofuScript.compile(csAst);

...
// Generated by MambaScript 0.4.1 
var _, addToWrapper, ArrayProto, breaker, escapeRegExp, hasOwnProperty, idCounter, nativeEvery, nativeFilter, nativeForEach, nativeIndexOf, nativeIsArray, nativeKeys, nativeLastIndexOf, nativeMap, nativeReduce, nativeReduceRight, nativeSome, ObjProto, previousUnderscore, propertyIsEnumerable, result, root, slice, toString, unshift, wrapper;
root = this;
  ...
  try {
    if (nativeForEach && obj.forEach === nativeForEach) {
      ...
      for (var cache$ = function () {
            var accum$;
            accum$ = [];
            for (var i$ = 0; 0 <= obj.length ? i$ < obj.length : i$ > obj.length; 0 <= obj.length ? ++i$ : --i$)
              accum$.push(i$);
            return accum$;
...
_.invoke = function (obj, method) {
  ...
  return function (accum$) {
    for (var i$ = 0, length$ = obj.length; i$ < length$; ++i$) {
      val = obj[i$];
      accum$.push((method ? val[method] : val).apply(val, args));
    }
    return accum$;
  }.call(this, []);
};
...
_.without = function (array) {
  ...
  return function (accum$) {
    for (var cache$ = _.toArray(array), i$ = 0, length$ = cache$.length; i$ < length$; ++i$) {
      val = cache$[i$];
...
_.compose = function () {
  ...
  return function () {
    ...
    for (var cache$ = function () {
          var accum$;
          accum$ = [];
          for (var i$ = funcs.length - 1; funcs.length - 1 <= 0 ? i$ <= 0 : i$ >= 0; funcs.length - 1 <= 0 ? ++i$ : --i$)
            accum$.push(i$);
          return accum$;
        }.apply(this, arguments), i$ = 0, length$ = cache$.length; i$ < length$; i$ += -1) {
      i = cache$[i$];
...
_.extend = function (obj) {
  var key, source, val;
  for (var cache$ = _.rest(arguments), i$ = 0, length$ = cache$.length; i$ < length$; ++i$) {
    source = cache$[i$];
    for (key in source) {
      val = source[key];
      obj[key] = val;
...
_.times = function (n, iterator, context) {
  ...
  return function (accum$) {
    for (var cache$ = function () {
      ...
      i = cache$[i$];
      accum$.push(iterator.call(context, i));
    }
    return accum$;
  }.call(this, []);
};
...
_.mixin = function (obj) {
  var name;
  return function (accum$) {
    for (var cache$ = _.functions(obj), i$ = 0, length$ = cache$.length; i$ < length$; ++i$) {
      name = cache$[i$];
      accum$.push(addToWrapper(name, _[name] = obj[name]));
    }
    return accum$;
  }.call(this, []);
};

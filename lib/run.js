...
// Generated by MambaScript 0.1.4 
var formatSourcePosition, MambaScript, Module, patched, patchStackTrace, path, runMain, runModule, SourceMapConsumer;
path = require('path');
...
runModule = function (module, jsSource, jsAst, filename) {
  ...
  if (jsAst)
    Module._sourceMaps[filename] = function () {
      return '' + MambaScript.sourceMap(jsAst, filename);
    };

...
Reporter = function () {
  ...
  Reporter.prototype.report = function () {
    ...
    errors = this.errors.map(function (param$) {
      ...
      return 'L' + node.line + ' ' + node.raw.inverse + ' ' + text.red + ' If you think that you found a bug in the language this error is generated from src/reporter.kofu help me improve it... this reporter is exported and used around the whole language';
    });
    return '' + errors.join('\n') + '';
  };

...
(function() {
  var ArrayInterface, ArrayType, CS, NumberInterface, ObjectInterface, ObjectType, Possibilites, Scope, Type, TypeSymbol, VarSymbol, checkAcceptableObject, clone, console, initializeGlobalTypes, pj, render, rewrite, util,
  ...
  rewrite = function(obj, replacer) {
    var key, val, _ref, _results;
    if ((_ref = typeof obj) === 'string' || _ref === 'number') {
      return;
    }
    _results = [];
    for (key in obj) {
      ...
      if ((typeof val) === 'string') {
        if (replacer[val] != null) {
          _results.push(obj[key] = replacer[val]);
        } else {
          _results.push(void 0);
        }
      } else if (val instanceof Object) {
        _results.push(rewrite(val, replacer));
      } else {
        _results.push(void 0);
      }
    }
  ...
  checkAcceptableObject = function(left, right) {
    ...
    if (((left != null ? left.base : void 0) != null) && (left.templates != null)) {
      left = left.base;
    }
  ...
  TypeSymbol = (function() {
    function TypeSymbol(_arg) {
      this.type = _arg.type, this["instanceof"] = _arg["instanceof"], this.templates = _arg.templates;
  ...
  Scope = (function() {
    ...
    Scope.prototype.getType = function(symbol) {
      var _ref;
      return ((_ref = this._types[symbol]) != null ? _ref.type : void 0) || void 0;
    };
    ...
    Scope.prototype.getThis = function(symbol) {
      var _ref, _ref1;
      return (_ref = (_ref1 = this._this[symbol]) != null ? _ref1.type : void 0) != null ? _ref : void 0;
    };

    Scope.prototype.addVar = function(symbol, type, implicit) {
      var T, n, obj, replacer, rewrite_to, t, _i, _len, _ref;
      if (implicit == null) {
        implicit = true;
      }
      console.log('addvar;', symbol, type);
      if ((type != null ? type.base : void 0) != null) {
    ...
    Scope.prototype.checkFunctionLiteral = function(left, right) {
      ...
      console.log(left);
      if ((left != null ? left.args : void 0) === void 0) {

...
var ArrayType, checkAcceptableObject, clone, console, initializeGlobalTypes, ObjectType, pj, Possibilites, render, reporter, rewrite, Scope, Type, TypeSymbol, VarSymbol;
console = {
  log: function () {
  }
};
      ...
      return function (accum$) {
        ...
        for (key in left) {
          ...
          if (right[key] === void 0 && ('undefined' !== typeof lval && null != lval)) {
            if (key === '_return_' || key === 'type' || key === 'possibilities')
              return;

...
Scope = function () {
  ...
  Scope.prototype.addVar = function (symbol, dataType) {
    var n, obj, replacer, rewrite_to, T, t;
    if (null != (null != dataType ? dataType._base_ : void 0)) {
      T = this.getType(dataType._base_);
      if (!T)
      ...
      return this._vars[symbol] = new VarSymbol({ dataType: obj });
    } else {
      return this._vars[symbol] = new VarSymbol({ dataType: dataType });
    }
  };

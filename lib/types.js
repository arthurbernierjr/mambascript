void function () {
    var _, cache$, clone, debug, find, initializeGlobalTypes, pj, render, reporter, rewrite, typeErrorText;
    pj = function () {
        try {
    ...
    initializeGlobalTypes = function (node) {
        var AnyType, BooleanType, FloatType, IntType, NumberType, StringType;
        AnyType = {
        ...
        return node.addPrimitiveType(BooleanType);
    };
    Scope = function () {
        ...
        Scope.prototype.getTypeByString = function (typeName) {
            var ret;
            ret = find(this.types, function (i) {

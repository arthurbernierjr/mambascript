...
var ArrayType, checkAcceptableObject, ClassScope, clone, debug, FunctionScope, initializeGlobalTypes, ObjectType, pj, Possibilites, render, reporter, reporter, rewrite, Scope, Type, typeErrorText, TypeSymbol, VarSymbol;
pj = function () {
  try {
...
Scope = function () {
  ...
  Scope.prototype.addType = function (symbol, dataType, _templates_) {
    ...
    if (null != (null != symbol ? symbol.left : void 0)) {
      ns = [];
      name = symbol.right;
      cur = symbol.left;
      while (true) {
      ...
      return cur.addType(name, dataType, _templates_);
    } else {

...
var ArrayType, checkAcceptableObject, console, CS, initializeGlobalTypes, ObjectType, pj, Possibilites, render, Scope, Type, TypeSymbol, util, VarSymbol;
console = {
  log: function () {
  }
};
...
checkAcceptableObject = function (left, right) {
  ...
  if (null != (null != right ? right.possibilities : void 0))
    for (var i$ = 0, length$ = right.possibilities.length; i$ < length$; ++i$) {
      ...
      return checkAcceptableObject(left, r);
    }

  ...
  return function (left, right) {
    ...
    if (null != (null != right ? right.possibilities : void 0)) {
      results = function (accum$) {
        ...
        for (var i$ = 0, length$ = right.possibilities.length; i$ < length$; ++i$) {
          ...
          accum$.push(checkAcceptableObject(left, r));
        }
        return accum$;
      }.call(this$, []);
    ...
    if (null != left ? left._args_ : void 0) {
      ...
      results = function (accum$) {
        ...
        for (var i$ = 0, length$ = left._args_.length; i$ < length$; ++i$) {
          l_arg = left._args_[i$];
          i = i$;
          accum$.push(checkAcceptableObject(l_arg, right._args_[i]));
        }
        return accum$;
      }.call(this$, []);
      return results.every(function (i) {
    ...
    if (null != (null != left ? left.array : void 0)) {
      ...
      results = function (accum$) {
        ...
        for (key in left) {
          lval = left[key];
          accum$.push(right[key] === void 0 && ('undefined' !== typeof lval && null != lval) && !(key === '_return_' || key === 'type' || key === 'possibilities') ? "'" + key + "' is not defined on right" : checkAcceptableObject(lval, right[key]));
        }
        return accum$;
      }.call(this$, []);
      return results.every(function (i) {

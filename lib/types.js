...
var _, ClassScope, clone, debug, FunctionScope, ImplicitAnyAnnotation, initializeGlobalTypes, primitives, rewrite, Scope;
...
Scope = function () {
  ...
  Scope.prototype.getThisByNode = function (node) {
    ...
    return null != (cache$1 = this.getThis(typeName)) ? cache$1.typeAnnotation : void 0;
  };
  ...
  Scope.prototype.getTypeByVarNode = function (node) {
    var cache$1, typeName;
    typeName = node.identifier.typeRef;
    return null != (cache$1 = this.getVarInScope(typeName)) ? cache$1.typeAnnotation : void 0;
  };
  Scope.prototype.getTypeByVarName = function (varName) {
    var cache$1;
    return null != (cache$1 = this.getVarInScope(varName)) ? cache$1.typeAnnotation : void 0;
  };
...
ClassScope = function (super$) {
  ...
  ClassScope.prototype.getConstructorType = function () {
    var cache$1;
    return null != (cache$1 = _.find(this._this, function (v) {
      return v.identifier.typeRef === '_constructor_';
    })) ? cache$1.typeAnnotation : void 0;
  };
  return ClassScope;
}(Scope);

void function () {
    var _, cache$, checkType, checkTypeAnnotation, ClassScope, correctExtends, CS, debug, extendFunctionType, extendMembers, extendType, formatType, FunctionScope, ImplicitAnyAnnotation, initializeGlobalTypes, isAcceptable, isAcceptableExtends, isAcceptableFunctionType, isAcceptablePrimitiveSymbol, isAcceptableStruct, reporter, resolveType, rewriteTypeWithArg, Scope, typeErrorText, util;
    ...
    extendMembers = function (scope, node, givenArgs) {
        ...
        return function (accum$) {
            for (var i$1 = 0, length$1 = node.identifier.typeArguments.length; i$1 < length$1; ++i$1) {
                ...
                n = i$1;
                givenArg = givenArgs[n];
                accum$.push(rewriteTypeWithArg(typeScope, node, arg, givenArg));
            }
            return accum$;
        }.call(this, []);
    };

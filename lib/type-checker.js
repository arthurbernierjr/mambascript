void function () {
    var _, cache$, checkType, checkTypeAnnotation, ClassScope, correctExtends, CS, debug, extendTypeWithArguments, FunctionScope, ImplicitAnyAnnotation, initializeGlobalTypes, isAcceptable, isAcceptableExtends, isAcceptableFunctionType, isAcceptablePrimitiveSymbol, isAcceptableStruct, reporter, resolveType, rewriteTypeWithArg, Scope, typeErrorText, util;
    ...
    rewriteTypeWithArg = function (scope, node, from, to) {
        var ann, i, n, prop, resolved, typeArgs;
        if (node.nodeType === 'identifier') {
            return node.typeAnnotation;
        } else if (node.nodeType === 'members') {
            return function (accum$) {
                for (var i$ = 0, length$ = node.properties.length; i$ < length$; ++i$) {
                    ...
                    accum$.push(function () {
                        ...
                        case 'identifier':
                            if (null != prop.typeAnnotation && null != prop.typeAnnotation.identifier && null != prop.typeAnnotation.identifier.typeArguments ? prop.typeAnnotation.identifier.typeArguments.length : void 0) {
                                typeArgs = function (accum$1) {
                                    for (var i$1 = 0, length$1 = prop.typeAnnotation.identifier.typeArguments.length; i$1 < length$1; ++i$1) {
                                        i = prop.typeAnnotation.identifier.typeArguments[i$1];
                                        n = i$1;
                                        resolved = resolveType(scope, i);
                                        accum$1.push(resolved.typeAnnotation);
                                    }
                                    return accum$1;
                                }.call(this, []);

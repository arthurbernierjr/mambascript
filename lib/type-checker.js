void function () {
    var _, cache$, checkType, checkTypeAnnotation, ClassScope, correctExtends, CS, debug, extendFunctionType, extendTypeWithArguments, FunctionScope, ImplicitAnyAnnotation, initializeGlobalTypes, isAcceptable, isAcceptableExtends, isAcceptableFunctionType, isAcceptablePrimitiveSymbol, isAcceptableStruct, reporter, resolveType, rewriteTypeWithArg, Scope, typeErrorText, util;
                    ...
                    accum$1.push(function () {
                        ...
                        case 'identifier':
                            if (null != prop.typeAnnotation && null != prop.typeAnnotation.identifier && null != prop.typeAnnotation.identifier.typeArguments ? prop.typeAnnotation.identifier.typeArguments.length : void 0) {
                                typeArgs = function (accum$2) {
                                    for (var i$2 = 0, length$2 = prop.typeAnnotation.identifier.typeArguments.length; i$2 < length$2; ++i$2) {
                                        i = prop.typeAnnotation.identifier.typeArguments[i$2];
                                        n = i$2;
                                        resolved = resolveType(scope, i);
                                        accum$2.push(resolved.typeAnnotation);
                                    }
                                    return accum$2;
                                }.call(this, []);

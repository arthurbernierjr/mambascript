void function () {
    ...
    walkClass = function (node, scope) {
        var arg, classScope, impl, parentAnnotation, parentStaticAnnotation, prop, statement, staticAnn, symbol;

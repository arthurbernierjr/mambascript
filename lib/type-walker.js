void function () {
        ...
        if (null != node.implementArguments ? node.implementArguments.length : void 0) {
            extendList = function (accum$) {
                for (var i$ = 0, length$ = node.implementArguments.length; i$ < length$; ++i$) {
                    ...
                    accum$.push(scope.getTypeInScope(implArg.identifier.typeRef));
                }
                return accum$;
            }.call(this, []);
    ...
    walkProgram = function (node, scope) {
        ...
        return node.typeAnnotation = { identifier: createReference('Program') };
    };
    ...
    walkClass = function (node, scope) {
        var arg, classScope, implArg, parentAnnotation, parentStaticAnnotation, prop, statement, staticAnn, symbol;
        ...
        if (null != node.implementArguments ? node.implementArguments.length : void 0)
            for (var i$1 = 0, length$1 = node.implementArguments.length; i$1 < length$1; ++i$1) {
                ...
                parentAnnotation = scope.getTypeInScope(implArg.identifier.typeRef);

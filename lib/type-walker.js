void function () {
    ...
    walkFor = function (node, scope) {
        var arrayType, preAnnotation, targetType;
        ...
        if (null != ('undefined' !== typeof arrayType && null != arrayType ? arrayType.identifier : void 0)) {
            if (null != node.body) {
                arrayType = _.clone(node.body.typeAnnotation);
                arrayType.identifier.isArray = true;
                return node.typeAnnotation = arrayType;
            } else {
                return node.typeAnnotation = ImplicitAnyAnnotation;
            }
        } else {

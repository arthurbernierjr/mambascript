void function () {
    ...
    compareAsParent = function (scope, a, b) {
        var retA, retB;
        if ((null != a.identifier ? a.identifier.typeRef : void 0) === 'Undefined' || (null != a.identifier ? a.identifier.typeRef : void 0) === 'Null') {
            b = _.clone(b);
            if (null != b.identifier)
                b.identifier.nullable = true;
            return b;
        }
        if ((null != b.identifier ? b.identifier.typeRef : void 0) === 'Undefined' || (null != b.identifier ? b.identifier.typeRef : void 0) === 'Null') {
            a = _.clone(b);
    ...
    walkSwitch = function (node, scope) {
        ...
        ret = _.clone(_.reduce(tail, function (a, b) {
    ...
    walkArrayInializer = function (node, scope) {
        ...
        head = cache$2[0];
        tail = 2 <= cache$2.length ? [].slice.call(cache$2, 1) : [];
        ann = _.clone(_.reduce(tail, function (a, b) {
            return compareAsParent(scope, a, b);
        }, head));
    ...
    walkClass = function (node, scope) {
            ...
            for (var i$ = 0, length$ = node.impl.length; i$ < length$; ++i$) {
                ...
                if (parentAnnotation)
                    parentAnnotation.properties.map(function (prop) {
                        return classScope.addThis(_.clone(prop));
                    });
            }
        if (null != node.parent) {
        ...
        if (null != node.nameAssignee ? node.nameAssignee.data : void 0)
            return scope.addType({
                ...
                members: {
                    nodeType: 'members',
                    properties: _.map(_.clone(classScope._this), function (prop) {

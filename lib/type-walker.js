void function () {
    ...
    walkMemberAccess = function (node, scope) {
        var childModule, member, mod, moduleFound, type;
        moduleFound = false;
        ...
        if (!moduleFound) {
            ...
            if (type = scope.getTypeByNode(node.expression.typeAnnotation)) {
                ...
                if (null != (null != member ? member.typeAnnotation : void 0)) {
                    return node.typeAnnotation = null != member ? member.typeAnnotation : void 0;
                } else {
                    return node.typeAnnotation = ImplicitAny;
                }
            } else if (null != node.typeAnnotation)

void function () {
    ...
    walkConditional = function (node, scope) {
        var alternateAnnotation, consequentAnnotation, parentType, t;
    ...
    walk = function (node, scope) {
        ...
        if (!(null != node))
            return;
        console.error('walking node:', null != node ? node.className : void 0, null != node ? node.raw2 : void 0);
        switch (false) {
        case !!(null != node):
            return;

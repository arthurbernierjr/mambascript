void function () {
    ...
    walkClass = function (node, scope) {
        var classScope, constructorScope, fname, statement, val;
        ...
        if (null != node.ctor) {
            ...
            if (null != (null != node.ctor.expression.body ? node.ctor.expression.body.statements : void 0))
                for (var i$1 = 0, length$1 = node.ctor.expression.body.statements.length; i$1 < length$1; ++i$1) {
                    statement = node.ctor.expression.body.statements[i$1];

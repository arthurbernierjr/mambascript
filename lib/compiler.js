// Generated by MambaScript 0.1.4 
...
expr = function (s) {
  ...
  if (s.isExpression) {
    ...
    throw new Error('expr: Cannot use a ' + s.type + ' as a value. no big deal take a look at your code. Are you sure you are following the KOFU principles of writing Unfancy Typed JavaScript If you think that you found a bug in the language this error is generated from src/compiler.mamba help me improve it');
  }
};
    ...
    [
      ...
      function (param$) {
        ...
        program.leadingComments = [{
            type: 'Line',
            value: ' Generated by MambaScript ' + pkg.version + ' \nvar present = console.log; \n// Generated by MambaScript ' + pkg.version + ' '
          }];
        return program;
      }
    ],
      ...
      function () {
        ...
        handleParam = function (param, original, block, inScope) {
          ...
          case !original['instanceof'](CS.DefaultParam):
            ...
            return p;
          default:
            throw new Error('Unsupported parameter type: ' + original.className + ' No worries big dog. If you read below you should see why this is the case. If you think that you found a bug in the language this error is generated from src/compiler.mamba help me improve it.');
          }
        };
        return function (param$) {
          ...
          if (parameters.length > 0) {
            ...
            if (any(parameters, function (p) {
              ...
              throw new Error('Parameter lists may not have more than one rest operator .... Give it a rest LOL Couldnt resist. If you think that you found a bug in the language this error is generated from src/compiler.mamba help me improve it');
          }
      ...
      function (param$) {
        ...
        op = function () {
          ...
          case CS.ExpOp.prototype.className:
            return '**';
          default:
            throw new Error('Unrecognised compound assignment operator +, -, *, /, **, &&, ?, || are the type of operators you can use as well as there text based subtitutes like also, and, or. If you think that you found a bug in the language this error is generated from src/compiler.mamba help me improve it');
          }
        }.call(this);

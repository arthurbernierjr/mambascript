...
expr = function (s) {
  ...
  if (s.isExpression) {
    ...
    throw new Error('expr: Cannot use a ' + s.type + ' as a value. no big deal take a look at your code. Are you sure you are following the KOFU principles of writing Unfancy Typed JavaScript');
  }
};
...
assignment = function (assignee, expression, valueUsed) {
  ...
  case !assignee['instanceof'](JS.ArrayExpression):
    ...
    if (elements.length > 0) {
      ...
      if (any(elements, function (p) {
        ...
        throw new Error('Positional destructuring assignments may not have more than one rest operator no big deal take a look at your code. Are you sure you are following the KOFU principles of writing Unfancy Typed JavaScript');
    }
    break;
  ...
  case !assignee['instanceof'](JS.Identifier, JS.GenSym, JS.MemberExpression):
    ...
    break;
  default:
    throw new Error('compile: assignment: unassignable assignee: ' + assignee.type + ' no big deal take a look at your code. Are you sure you are following the KOFU principles of writing Unfancy Typed JavaScript');
  }
...
exports.Compiler = function () {
  ...
  defaultRules = [
    ...
    [
      ...
      function (param$) {
        ...
        if (null != alternate) {
          if (!(null != consequent))
            throw new Error('Conditional with non-null alternate requires non-null consequent no big deal take a look at your code. Are you sure you are following the KOFU principles of writing Unfancy Typed JavaScript');
        ...
        return function (param$) {
          ...
          if (parameters.length > 0) {
            ...
            if (any(parameters, function (p) {
              ...
              throw new Error('Parameter lists may not have more than one rest operator .... Give it a rest LOL Couldnt resist');
          }
  ...
  Compiler.prototype.compile = function () {
    ...
    defaultRule = function () {
      throw new Error('compile: Non-exhaustive patterns in case: ' + this.className + ' no big deal take a look at your code. Are you sure you are following the KOFU principles of writing Unfancy Typed JavaScript');
    };

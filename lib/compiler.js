void function () {
    ...
    inlineHelpers = {
        ...
        'super': function (className, functionName, args) {
            var calledExprs;
            if (args.length === 0) {
    ...
    exports.Compiler = function () {
        ...
        defaultRules = [
            [
                ...
                function (param$) {
                    ...
                    program.leadingComments = [{
                            type: 'Line',
                            value: ' Generated by TypedCoffeeScript ' + pkg.version
                        }];
                    return program;
                }
            ],
            ...
            [
                CS.Super,
                function (param$) {
                    var ancestry, args, cache$2, calledExprs, classAssignNode, className, classNode, classPositionInAncestry, compile, functionName, inScope, isProtoMemberAccess, isStatic;
                    {
                        cache$2 = param$;
            ...
            [
                CS.Module,
                function (param$) {
                    var args, argsLiteral, body, cache$2, cur, ident, literalName;
                    {
                        cache$2 = param$;
                        ident = cache$2.ident;
                        body = cache$2.body;
                    ...
                    if (null != ident.name) {
                        return new JS.CallExpression(new JS.Identifier('_module_'), [
                        ...
                        argsLiteral = args.map(function (i) {
                            return new JS.Identifier(i);
                        });
                        return new JS.CallExpression(new JS.Identifier('_module_'), [
            ...
            [
                ...
                function (param$) {
                    ...
                    if (null != right)
                        args.push(this.isInclusive ? right['instanceof'](JS.Literal) && typeof right.data === 'number' ? new JS.Literal(right.data + 1) : new JS.LogicalExpression('||', new JS.BinaryExpression('+', new JS.UnaryExpression('+', right), new JS.Literal(1)), new JS.Literal(9000000000)) : right);

...
inlineHelpers = {
  ...
  'super': function (className, functionName, args) {
    var applied;
    applied = args.length > 0 ? new JS.ArrayExpression(map(args, expr)) : new JS.Identifier('arguments');
...
exports.Compiler = function () {
  ...
  defaultRules = [
    ...
    [
      CS.Super,
      function (param$) {
        var ancestry, args, cache$2, className, classNode, compile, functionName, inScope;
        {
          cache$2 = param$;
        ...
        classNode = find(ancestry, function (node) {
          return node.hasOwnProperty('ctor');
        });
        functionName = ancestry[ancestry.indexOf(classNode) - 1].assignee.data;
        className = classNode.name.data;
        return helpers['super'](className, functionName, args);
      }
    ],
    [

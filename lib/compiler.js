...
exports.Compiler = function () {
  ...
  defaultRules = [
    ...
    [
      CS.Super,
      function (param$) {
        var ancestry, args, cache$2, classAssignNode, className, classNode, classPositionInAncestry, compile, functionName, i, inScope, n, searchableNodes;
        {
          cache$2 = param$;
        ...
        classAssignNode = find(searchableNodes, function (node) {
